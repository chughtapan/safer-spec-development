/**
 * @specPurpose Property stubs for the CLI surface. Exception Raising: the
...
/**
 * @specProperty cli-validate-rejects-conflicting-flags
 * @specType Exception Raising
 * @specExports validate
 * @specClaim --planned and --implemented passed together fail with CliUsageError exit code 2
 */
...
/**
 * @specProperty cli-validate-exit-code-contract
 * @specType Exception Raising
 * @specExports validate
 * @specClaim ValidateGapError tags propagate to process.exit(N) with N in {11, 12, 13}
 */
