/**
 * @specPurpose Format version constant for SPEC.md frontmatter and the
...
/**
 * @specGuarantee "value is a stable string literal across all calls within one process"
 *   reason: declared `as const` in source; re-evaluation cannot drift.
 * @specResidualContract "callers must treat as opaque; format-version comparisons go through `migrate`"
