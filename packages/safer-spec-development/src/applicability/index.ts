...
import type { DetectedExport } from "../kind-detector/index.js";
...
export const resolveFolder = (
  _detected: ReadonlyArray<DetectedExport>,
): Effect.Effect<ReadonlyArray<ResolvedExport>, ApplicabilityResolutionError> =>
  Eff.die(new Error("Stage 1 stub: resolveFolder not implemented"));

export { APPLICABILITY_MATRIX } from "./matrix.js";
export type { ApplicabilityRow } from "./matrix.js";
export { isOverridden } from "./override.js";
export type { OverrideContext } from "./override.js";
