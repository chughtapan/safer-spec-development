...
export type LinkOutcome = LinkResolution | UnresolvedExternal;
...
export const resolveAll = (
  _references: ReadonlyArray<{ symbol: string; fromFile: string }>,
): Effect.Effect<ReadonlyArray<LinkOutcome>, LinkResolutionError> =>
  Eff.die(new Error("Stage 1 stub: resolveAll not implemented"));
